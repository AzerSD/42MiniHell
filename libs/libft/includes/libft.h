 ...
 * 0 if they are equal.
 */
int32_t					ft_strncmp(const char *str1, const char *str2,
							size_t n);
 ...
 * whenever a variable has to be printed. (ex: "Hiello %s", where
	%s is a string)
 ...
 * @param exit_nbr If -1
 */
void					error_line(char *msg, int32_t line, char *file,
							int32_t exit_nbr);
