...
/*   Updated: 2023/08/25 14:26:51 by lhasmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char						*build_path_and_check_existence(char *p, char *p2,
								char *file, int plen);
/**
 ...
 */
void						parse_ast(t_node *node, int *argc, int *targc,
								char ***argv);
