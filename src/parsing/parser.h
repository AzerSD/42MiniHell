...
/*   Updated: 2023/08/27 02:13:47 by lhasmi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_node			*execute_heredoc(t_shell *g_shell, t_heredoc_data *data,
					t_node *ptr);
...
void			handle_parent_process(t_shell *g_shell, int *pipe_fd,
					t_token *tok, int tmp_fd);
void			write_to_pipe_and_cleanup(t_shell *g_shell, int *pipe_fd,
					t_token *tok, int tmp_fd, char *content);
